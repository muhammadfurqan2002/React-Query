...
function Products() {
    ...
    const { data: products } = useQuery({
        queryKey: ['products', limit, skip, q,category], //important keep it in mind
        ...
        placeholderData: keepPreviousData, // important 
        staleTime:20000
    });

    const handleMove = (moveCount) => {
        //  skip=0 default ,movecount=4 can be 4 or -4 depend on button which pressed 
        // performing for next page
        // 0+4=4
        // 4+4=8 

        // performing for previous
        // 0-4=-4 inavlid 
